...
float4 DiffuseSpecularAndAmbientForADirectionalLight(float3 ambientColor, float4 surfaceColor, float3 normalVector, float3 directionToLight, float3 lightColor, float3 cameraPosition, float3 worldPosition, float roughness)
{
